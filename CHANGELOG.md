...
- **Verifiche Dev/Production-Like e UI Wrapping**: confermati il target `fantaf1_dev` in locale, la compatibilita' production-like su build preview e la tenuta responsive del CTA highlights su admin/public, desktop/mobile; migliorato inoltre il wrapping del pulsante nel recap del weekend selezionato.
