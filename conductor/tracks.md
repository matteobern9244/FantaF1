...
- `refactor_spa_to_multi_page_app_pwa_20260321` | Refactoring dell'intera applicazione da SPA a App Multi-Pagina (PWA) con routing reale, navigazione mobile ottimizzata (Bottom Tab Bar) e notifiche push | `completed` | phase `completed` | Completed | `conductor/tracks/refactor_spa_to_multi_page_app_pwa_20260321`

## Archived Tracks

- `achieve_100_coverage_20260314` | Certificazione Copertura Test 80% (Frontend, Node, C#) | `archived` | phase `archived` | Archived | `conductor/archive/achieve_100_coverage_20260314`
...
- `persistent_race_highlights_backfill_utc_hardening_20260320` | Persistenza definitiva highlights per gara con backfill ufficiale F1, matching Sky/YouTube e hardening UTC su Render | `archived` | phase `archived` | Archived | `conductor/archive/persistent_race_highlights_backfill_utc_hardening_20260320`
...
- `protect_staging_branch_20260318` | proteggere il branch 'staging' a livello di github in modo identico a come è protetto il branch 'main' | `completed` | phase `completed` | Completed | `conductor/archive/protect_staging_branch_20260318`
...
- `stabilize_highlights_persistence_20260318` | Persistenza Definitiva Highlights Per Gara | `completed` | phase `completed` | Implementation, coverage, responsive verification, and production-like preview checks completed without commit or push. | `conductor/archive/stabilize_highlights_persistence_20260318`
- `streamline_core_docs_20260318` | Streamline core documentation (GEMINI.md & AGENTS.md) | `archived` | phase `archived` | Archived | `conductor/archive/streamline_core_docs_20260318`
...
- `track-002` | Riordinare il menu e le voci dashboard con sottomenu Analisi per KPI e coerenza desktop/mobile/PWA | `archived` | phase `archived` | Archived | `conductor/archive/track-002-riordinare-il-menu-e-le-voci-dashboard-con-sottomenu-analisi-per-kpi-e-coerenza-desktop-mobile-pwa`
...
- `verify_workflow_20260314` | Verifica e certificazione della copertura test al 80% e dell'integrità del workflow Conductor | `archived` | phase `archived` | Archived | `conductor/archive/verify_workflow_20260314`
