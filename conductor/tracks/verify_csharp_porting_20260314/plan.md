...
- [ ] Task: Verifica Stato Salute C#
    ...
    - [ ] Eseguire `npm run test:csharp-coverage` e certificare il 100% su `backend-csharp/src/`.
- [ ] Task: Conductor - User Manual Verification 'Fase 1 - Qualità' (Protocollo in workflow.md)
...
- [ ] Task: Conductor - User Manual Verification 'Fase 2 - Parità' (Protocollo in workflow.md)
...
- [ ] Task: Verifica Script Parametrizzati
    ...
    - [ ] Eseguire `npm run test:ui-responsive` (check viste) puntando al frontend servito da C#.
- [ ] Task: Conductor - User Manual Verification 'Fase 3 - Strumenti' (Protocollo in workflow.md)
