...
## Objective
Ensure the highlights resolver finds videos for every finished race when available, not just the first race that happens to match current naming assumptions, and align the unavailable CTA copy to `HIGHLIGHTS NON PRESENTI`.
