...
La versione attualmente in produzione e pubblicata e' `v1.4.4`. Il repository e' aggiornato alla versione `v1.4.7` in `package.json`, includendo l'integrazione del framework Conductor, la certificazione del workflow e il fix del build Docker.
