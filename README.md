...
- overlay mobile rifinito per leggibilita' e orientamento: label delle voci in font `Formula1`, card piu' alte, contenuto centrato e wrapping meno aggressivo per evitare label schiacciate sui viewport stretti
